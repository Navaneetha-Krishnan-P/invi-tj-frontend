...
// Sign Up
export const signup = async (user_id, name, email, phone, password) => {
  try {
    const response = await fetch(`${API_URL}/signup`, {
      ...
      body: JSON.stringify({ user_id, name, email, phone, password }),
    });
...
export const logout = () => {
  ...
  localStorage.removeItem('maintenanceShownFor');
};
